...
Start at [quickstart.md](quickstart.md), then load only the contract needed:
...
[../AGENTS.md](../AGENTS.md) owns maintainer rules. Executable public examples are in
[../examples](../examples). Tests must refute a documented behavior.
